...
//The Triangle class implements the IIntersectable interface and represents a triangle in a 3D environment.
// It provides methods to set and retrieve the triangle's vertices and normals, and calculates intersections with rays.
