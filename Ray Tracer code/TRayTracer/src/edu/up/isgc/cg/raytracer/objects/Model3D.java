...
//The model3D class creates 3D models and prompts for all the necessary information to generate them.
public class Model3D extends Object3D{
    private List<Triangle> triangles;

    public Model3D(Vector3D position, Triangle[] triangles, Color color, double reflection) {
